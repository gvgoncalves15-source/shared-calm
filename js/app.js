...
function openProfileModal(mode) {
  ...
  const pwConfirmInput = document.getElementById('profile-password-confirm');
  ...
  if (mode === 'edit') {
    ...
    pwConfirmInput.classList.add('hidden');
    ...
    pwConfirmInput.classList.remove('hidden');
...
on('form-profile', 'submit', async (e) => {
  ...
  if (profileModalMode === 'create' && password !== passwordConfirm) { toast('As senhas não coincidem', true); return; }
